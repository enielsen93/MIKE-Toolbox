...
<qgis version="3.36.3-Maidenhead">
  <identifier>ms_CatchmentImp122</identifier>
  <parentidentifier></parentidentifier>
  <language>DAN</language>
  <type>dataset</type>
  <title>ms_CatchmentImp122</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link url="file://\\APC110\C$\Program Files\DHI\MIKE URBAN\Templates\muDefault.mdb" description="" mimeType="" format="" size="" name="File Geodatabase Feature Class" type="Local Area Network"/>
  </links>
  <dates/>
  <fees></fees>
